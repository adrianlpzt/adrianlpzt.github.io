...
### >_ location: Córdoba, ES (Available for remote)
### >_ uptime: Since 2018
...
A diferencia de un técnico puro, mi experiencia previa en ventas [cite: 21] me permite entender que la seguridad debe alinearse con los objetivos de negocio: no busco fallos por diversión, busco riesgos que te hagan perder dinero.
...
* **Web Security:** Protección contra XSS y SQL Injection, Hardening de PHP y Apache/XAMPP.
* **Scripting:** Bash y Python (para automatización de tareas de seguridad).
...
```
<div style="width:100%; text-align: center;display: flex; align-items: center; margin-bottom: 30px; background-color: #111; padding: 15px; border: 1px dashed #333; border-radius: 5px;">
